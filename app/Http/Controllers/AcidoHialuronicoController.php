...
class AcidoHialuronicoController extends Controller{


    public function asido_hialuronico(){
        ...
        $especialidades = $this->especialidad(3);

        return view("acido_hialuronico", compact("phone", "email_contact", "facebook", 
                                                    "twtter", "direccion", "selected", 
                                                    "instagram", "url_general", 
                                                    "especialidades"));
    }
