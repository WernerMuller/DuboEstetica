...
class MicropigmentacionController extends Controller{
    
    public function micropigmentacion(){
        ...
        $especialidades = $this->especialidad(4);

        return view("micropigmentacion", compact("phone", "email_contact", "facebook", 
