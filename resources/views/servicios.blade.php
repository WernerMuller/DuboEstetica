                ...
                <div class="col-md-6">
                    ...
                    <div class="welcome-detail">
                        <div class="row">
                            ...
                            {{-- <div class="col-md-5">
                                <img src="{{ asset("assets/images/welcome-img.jpg") }}" alt="">
                            </div>
                            --}}
                            <div class="col-md-12">
                                <div class="detail">
                               ...
                               @if(count(get_restriccion($id_servicio)) > 0)
                               <table class="table">
                                <thead>
                                  <tr>
                                    <th scope="col">Concideraciones</th>
                                  </tr>
                                </thead>
                                <tbody>
                                @foreach(get_restriccion($id_servicio) as $item)
                                  <tr>
                                    <td>{{ $item->nota }}</td>
                                  </tr>
                                @endforeach
