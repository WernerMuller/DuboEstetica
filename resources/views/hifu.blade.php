        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-title">
                        <h2><span>EL LIFTING</span> SIN CIRUGÍA</h2>
                        <p> Es una novedosa técnica de estética ideal para el rejuvenecimiento. En
                            español Ultrasonidos Focalizados de Alta Intensidad. Consigue eliminar en una sola
                            sesión la flacidez en la piel, ofreciendo un rostro más terso. Los efectos son muy
                            similares a los del lifting y sin necesidad de pasar por cirugía.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="tabbed-nav">
                <ul>
                    ...
                    <li class="demo-1" {{ $index == 0 ? 'id="firts-icon-select"' :'' }}><a  href="">{{ $item->nombre }}</a></li>
                    @endforeach
                </ul>
